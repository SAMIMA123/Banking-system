...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color :lightgoldenrodyellow;">
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    <img src="img/tranfer.jpg" class="img-fluid"    style=" margin: 78px 0 00 00px;"
}>
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>SAMIMA  NASRIN</b> <br> The Spark Foundation</p>
      </footer>
